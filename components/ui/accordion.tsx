  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <Plus
          data-slot="accordion-trigger-icon"
          className="pointer-events-none lg:size-8 shrink-0 text-primary-black! group-aria-expanded/accordion-trigger:hidden"
        />

        <Minus
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden lg:size-8 shrink-0 text-primary-black! group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
